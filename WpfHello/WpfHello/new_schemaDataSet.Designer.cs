...
namespace WpfHello {
    ...
    public partial class new_schemaDataSet : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userRow AdduserRow(int iduser, string name) {
...
namespace WpfHello.new_schemaDataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `user` WHERE ((`iduser` = @p1) AND ((@p2 = 1 AND `name` IS NULL) OR (" +
                "`name` = @p3)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `user` (`iduser`, `name`) VALUES (@p1, @p2)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `user` SET `iduser` = @p1, `name` = @p2 WHERE ((`iduser` = @p3) AND ((@p4 " +
                "= 1 AND `name` IS NULL) OR (`name` = @p5)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfHello.Properties.Settings.Default.new_schemaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `iduser`, `name` FROM `user`";
        ...
        public virtual int Fill(new_schemaDataSet.userDataTable dataTable) {
        ...
        public virtual new_schemaDataSet.userDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            new_schemaDataSet.userDataTable dataTable = new new_schemaDataSet.userDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(new_schemaDataSet.userDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(new_schemaDataSet dataSet) {
